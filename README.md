# MissKeeper
Google-Keep-Based application build with Vue, that allows users to make different kinds of notes, including text, lists, images, video (via Youtube link), and also map locations. The notes are saved automatically in the Local Storage
